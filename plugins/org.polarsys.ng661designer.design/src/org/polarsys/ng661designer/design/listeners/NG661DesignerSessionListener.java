...
public class NG661DesignerSessionListener implements SessionManagerListener {
	...
	public static final NotificationFilter CREATE_REPRESENTATION = new NotificationFilter.Custom() {
		...
		public boolean matches(Notification notification) {
			return (notification.getFeature() == Part2Package.eINSTANCE.getComponentDefinitionType_Behavior() || notification.getFeature() == Part2Package.eINSTANCE.getComponentDefinitionType_Interface() || notification.getFeature() == Part2Package.eINSTANCE.getComponentDefinitionType_Tree()
