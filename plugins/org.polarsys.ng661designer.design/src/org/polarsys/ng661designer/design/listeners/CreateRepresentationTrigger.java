...
public class CreateRepresentationTrigger implements ModelChangeTrigger {
	...
	protected void createRepresentations(ComponentDefinitionType component) {
		...
		BehaviorType behavior = component.getBehavior();
		if (behavior != null) {
			createRepresentation(behavior);
		}
		InterfaceType interface1 = component.getInterface();
		if (interface1 != null) {
			createRepresentation(interface1);
		}
		TreeType tree = component.getTree();
		if (tree != null) {
