...
public class EcoreServices {
	 ...
	 */
	public EObject createIDElement(EObject container, String className, boolean touch) {
		...
		if (eClass != null) {
			...
			if (idFeature != null) {
				element.eSet(idFeature, name);
			}
			EStructuralFeature featureParent = getFeatureServices().getParentFeature(container, eClass, touch);
