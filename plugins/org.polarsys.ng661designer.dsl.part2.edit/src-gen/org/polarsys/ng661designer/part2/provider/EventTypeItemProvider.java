...
/**
 * This is the item provider adapter for a {@link org.polarsys.ng661designer.part2.EventType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventTypeItemProvider 
	...
	public Object getImage(Object object) {
		if (object instanceof EventType) {
			EStructuralFeature containingFeature = ((EventType)object).eContainingFeature();
			if (Part2Package.eINSTANCE.getInterfaceType_Event().equals(containingFeature)) {
				return overlayImage(object, getResourceLocator().getImage("full/obj16/EventType"));
			} else if (Part2Package.eINSTANCE.getInterfaceType_EnumEvent().equals(containingFeature)) {
				return overlayImage(object, getResourceLocator().getImage("full/obj16/EnumEventType"));
			}
		}
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventType"));
	}
