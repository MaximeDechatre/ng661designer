...
/**
 * This is the item provider adapter for a {@link org.polarsys.ng661designer.part2.PathPrimitive} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PathPrimitiveItemProvider extends ClipPathTypesItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathPrimitive_blocked_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathPrimitive_blocked_feature", "_UI_PathPrimitive_type"),
				 Part2Package.eINSTANCE.getPathPrimitive_Blocked(),
				 true,
				 false,
				 false,
	...
	protected void addEnablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathPrimitive_enable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathPrimitive_enable_feature", "_UI_PathPrimitive_type"),
				 Part2Package.eINSTANCE.getPathPrimitive_Enable(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInheritedBlockedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathPrimitive_inheritedBlocked_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathPrimitive_inheritedBlocked_feature", "_UI_PathPrimitive_type"),
				 Part2Package.eINSTANCE.getPathPrimitive_InheritedBlocked(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInheritedEnablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathPrimitive_inheritedEnable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathPrimitive_inheritedEnable_feature", "_UI_PathPrimitive_type"),
				 Part2Package.eINSTANCE.getPathPrimitive_InheritedEnable(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addInheritedVisiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathPrimitive_inheritedVisible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathPrimitive_inheritedVisible_feature", "_UI_PathPrimitive_type"),
				 Part2Package.eINSTANCE.getPathPrimitive_InheritedVisible(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVisiblePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PathPrimitive_visible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PathPrimitive_visible_feature", "_UI_PathPrimitive_type"),
				 Part2Package.eINSTANCE.getPathPrimitive_Visible(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Part2Package.eINSTANCE.getPathPrimitive_D());
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(Part2Package.eINSTANCE.getPathPrimitive_D(),
				 Part2Factory.eINSTANCE.createPathArray()));
	}
