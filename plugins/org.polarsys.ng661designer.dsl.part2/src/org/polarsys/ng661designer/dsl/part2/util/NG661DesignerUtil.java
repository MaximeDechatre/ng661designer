...
public class NG661DesignerUtil {
	 ...
	 * @param feature
	 *            EStructuralFeature
	 * @return if feature is a tree feature.
	 */
	public static boolean isTreeCase(EStructuralFeature feature) {
		return Part2Package.eINSTANCE.getTreeType_Group().equals(feature) || CHILD_ELEMENTS_FEATURE.equals(feature.getName());
	}
	 ...
	 * @return if feature is a tree feature.
	 */
	public static boolean isTreeCase(EClass eClass) {
		return Part2Package.eINSTANCE.getTreeType().equals(eClass) || Part2Package.eINSTANCE.getTreeTypes().isSuperTypeOf(eClass);
	}
	...
	public static ComponentDefinitionType getWidgetCompositionRepresentation(EObject object, String componentName) {
		...
		if (component != null) {
			...
			DefinitionType definition = component.getDefinition();
			if (definition != null) {
				for (ImportType importType : definition.getImport()) {
	...
	public static ComponentDefinitionType getComponentDefinition(EObject object) {
		...
		if (object instanceof TreeType && object.eContainer() instanceof ComponentDefinitionType) {
