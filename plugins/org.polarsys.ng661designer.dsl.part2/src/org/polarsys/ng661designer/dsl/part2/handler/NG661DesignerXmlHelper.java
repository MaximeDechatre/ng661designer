...
public class NG661DesignerXmlHelper extends XMLHelperImpl {
	...
	public String getQName(EStructuralFeature feature) {
		...
		if (ePackage != null && feature instanceof EReference && (((EReference) feature).isContainment() || NG661DesignerUtil.isTreeCase(feature.getEContainingClass()))) {
			String name = feature.getName();
			// handle special case of reference group1 in TreeType.
	...
	public EStructuralFeature getFeature(EClass eClass, String namespaceURI, String name, boolean isElement) {
		...
		// handle special case of reference group1 in TreeType.
		if (lowerCaseName != null && lowerCaseName.equalsIgnoreCase("group") && eClass.getName().equalsIgnoreCase("TreeType")) {
