...
public class ScxmlTransitionTypeImpl extends MinimalEObjectImpl.Container implements ScxmlTransitionType {
	 ...
	 * @ordered
	 */
	protected static final ScxmlTransitionTypeType TYPE_EDEFAULT = ScxmlTransitionTypeType.EXTERNAL;
	 ...
	 * @ordered
	 */
	protected ScxmlTransitionTypeType type = TYPE_EDEFAULT;
	 ...
	 * @generated
	 */
	public ScxmlTransitionTypeType getType() {
		return type;
	}
	 ...
	 * @generated
	 */
	public void setType(ScxmlTransitionTypeType newType) {
		ScxmlTransitionTypeType oldType = type;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ScxmlPackage.SCXML_TRANSITION_TYPE__TARGET:
				...
				return;
			case ScxmlPackage.SCXML_TRANSITION_TYPE__TYPE:
				setType((ScxmlTransitionTypeType)newValue);
				return;
		}
