...
import org.polarsys.ng661designer.part2.impl.Part2PackageImpl;
...
import org.w3._2005._07.scxml.ScxmlTransitionTypeType;
...
public class ScxmlPackageImpl extends EPackageImpl implements ScxmlPackage {
	 ...
	 * @generated
	 */
	private EEnum scxmlTransitionTypeTypeEEnum = null;
	 ...
	 * @generated
	 */
	private EDataType scxmlTransitionTypeTypeObjectEDataType = null;
	...
	public EAttribute getScxmlOnexecuteType_AnyAttribute() {
		return (EAttribute)scxmlOnexecuteTypeEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getScxmlTransitionType_Cond() {
		return (EAttribute)scxmlTransitionTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EEnum getScxmlTransitionTypeType() {
		return scxmlTransitionTypeTypeEEnum;
	}
	 ...
	 * @generated
	 */
	public EDataType getScxmlTransitionTypeTypeObject() {
		return scxmlTransitionTypeTypeObjectEDataType;
	}
	...
	public void createPackageContents() {
		...
		// Create enums
		scxmlTransitionTypeTypeEEnum = createEEnum(SCXML_TRANSITION_TYPE_TYPE);
		...
		scxmlTransitionTypeTypeObjectEDataType = createEDataType(SCXML_TRANSITION_TYPE_TYPE_OBJECT);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getScxmlTransitionType_Event(), this.getScxmlTransitionEventType(), "event", null, 1, 1, ScxmlTransitionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScxmlTransitionType_Target(), this.getScxmlIdType(), "target", null, 1, 1, ScxmlTransitionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getScxmlTransitionType_Type(), this.getScxmlTransitionTypeType(), "type", "external", 0, 1, ScxmlTransitionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(scxmlTransitionTypeTypeEEnum, ScxmlTransitionTypeType.class, "ScxmlTransitionTypeType");
		addEEnumLiteral(scxmlTransitionTypeTypeEEnum, ScxmlTransitionTypeType.INTERNAL);
		addEEnumLiteral(scxmlTransitionTypeTypeEEnum, ScxmlTransitionTypeType.EXTERNAL);
		...
		initEDataType(scxmlTransitionTypeTypeObjectEDataType, ScxmlTransitionTypeType.class, "ScxmlTransitionTypeTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (scxmlTransitionTypeTypeEEnum, 
		   source, 
		   new String[] {
			 "name", "scxml.transition.type.type"
		   });	
		addAnnotation
		  (scxmlTransitionTypeTypeObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "scxml.transition.type.type:Object",
			 "baseType", "scxml.transition.type.type"
		   });	
		addAnnotation
		  (documentRootEClass, 
		   source, 
