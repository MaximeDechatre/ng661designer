...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Reverse Video Properties</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ReverseVideoPropertiesImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ReverseVideoPropertiesImpl#getAscenderMargin <em>Ascender Margin</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ReverseVideoPropertiesImpl#getDescenderMargin <em>Descender Margin</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ReverseVideoPropertiesImpl#getEndMargin <em>End Margin</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ReverseVideoPropertiesImpl#getStartMargin <em>Start Margin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReverseVideoPropertiesImpl extends MinimalEObjectImpl.Container implements ReverseVideoProperties {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected ReverseVideoPropertiesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getReverseVideoProperties();
	}
	...
	public void setActive(Object newActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.REVERSE_VIDEO_PROPERTIES__ACTIVE, oldActive, active));
	}
	...
	public void setAscenderMargin(Object newAscenderMargin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.REVERSE_VIDEO_PROPERTIES__ASCENDER_MARGIN, oldAscenderMargin, ascenderMargin));
	}
	...
	public void setDescenderMargin(Object newDescenderMargin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.REVERSE_VIDEO_PROPERTIES__DESCENDER_MARGIN, oldDescenderMargin, descenderMargin));
	}
	...
	public void setEndMargin(Object newEndMargin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.REVERSE_VIDEO_PROPERTIES__END_MARGIN, oldEndMargin, endMargin));
	}
	...
	public void setStartMargin(Object newStartMargin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.REVERSE_VIDEO_PROPERTIES__START_MARGIN, oldStartMargin, startMargin));
	}
