...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Struct Entry Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.StructEntryTypeImpl#getField <em>Field</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.StructEntryTypeImpl#getArrayField <em>Array Field</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.StructEntryTypeImpl#getStructField <em>Struct Field</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.StructEntryTypeImpl#getEnumField <em>Enum Field</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.StructEntryTypeImpl#getUnionField <em>Union Field</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.StructEntryTypeImpl#getIndex <em>Index</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructEntryTypeImpl extends MinimalEObjectImpl.Container implements StructEntryType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getStructEntryType();
	}
	...
	public EList<FieldType> getField() {
		if (field == null) {
			field = new EObjectContainmentEList<FieldType>(FieldType.class, this, Part2Package.STRUCT_ENTRY_TYPE__FIELD);
		}
		return field;
	}
	...
	public EList<ArrayFieldType> getArrayField() {
		if (arrayField == null) {
			arrayField = new EObjectContainmentEList<ArrayFieldType>(ArrayFieldType.class, this, Part2Package.STRUCT_ENTRY_TYPE__ARRAY_FIELD);
		}
		return arrayField;
	}
	...
	public EList<StructFieldType> getStructField() {
		if (structField == null) {
			structField = new EObjectContainmentEList<StructFieldType>(StructFieldType.class, this, Part2Package.STRUCT_ENTRY_TYPE__STRUCT_FIELD);
		}
		return structField;
	}
	...
	public EList<FieldType> getEnumField() {
		if (enumField == null) {
			enumField = new EObjectContainmentEList<FieldType>(FieldType.class, this, Part2Package.STRUCT_ENTRY_TYPE__ENUM_FIELD);
		}
		return enumField;
	}
	...
	public EList<UnionFieldType> getUnionField() {
		if (unionField == null) {
			unionField = new EObjectContainmentEList<UnionFieldType>(UnionFieldType.class, this, Part2Package.STRUCT_ENTRY_TYPE__UNION_FIELD);
		}
		return unionField;
	}
	...
	public void setIndex(Object newIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.STRUCT_ENTRY_TYPE__INDEX, oldIndex, index));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Part2Package.STRUCT_ENTRY_TYPE__FIELD:
				return ((InternalEList<?>)getField()).basicRemove(otherEnd, msgs);
			case Part2Package.STRUCT_ENTRY_TYPE__ARRAY_FIELD:
				return ((InternalEList<?>)getArrayField()).basicRemove(otherEnd, msgs);
			case Part2Package.STRUCT_ENTRY_TYPE__STRUCT_FIELD:
				return ((InternalEList<?>)getStructField()).basicRemove(otherEnd, msgs);
			case Part2Package.STRUCT_ENTRY_TYPE__ENUM_FIELD:
				return ((InternalEList<?>)getEnumField()).basicRemove(otherEnd, msgs);
			case Part2Package.STRUCT_ENTRY_TYPE__UNION_FIELD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Part2Package.STRUCT_ENTRY_TYPE__INDEX:
				return getIndex();
		}
