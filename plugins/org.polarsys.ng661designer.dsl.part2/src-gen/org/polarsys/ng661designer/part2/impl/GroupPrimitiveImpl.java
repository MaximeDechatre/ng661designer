 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getChildElements <em>Child Elements</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getTransformGroup <em>Transform Group</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getReplicate <em>Replicate</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getSwitchNode <em>Switch Node</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getClippingContainer <em>Clipping Container</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getRectangle <em>Rectangle</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getCircle <em>Circle</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getEllipse <em>Ellipse</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getLine <em>Line</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getPolyline <em>Polyline</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getPolygon <em>Polygon</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getImage <em>Image</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getSimpleText <em>Simple Text</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getArc <em>Arc</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getCrown <em>Crown</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getPolarLine <em>Polar Line</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getPointerArea <em>Pointer Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getPointerGestureArea <em>Pointer Gesture Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getTouchArea <em>Touch Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getGestureArea <em>Gesture Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getKeyboardInput <em>Keyboard Input</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getScrollWheelInput <em>Scroll Wheel Input</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getCompositions <em>Compositions</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getBlocked <em>Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getDrawingPriority <em>Drawing Priority</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getEnable <em>Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getInheritedBlocked <em>Inherited Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getInheritedEnable <em>Inherited Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getInheritedVisible <em>Inherited Visible</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getTx <em>Tx</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getTy <em>Ty</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.GroupPrimitiveImpl#getVisible <em>Visible</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupPrimitiveImpl extends TreeTypesImpl implements GroupPrimitive {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final Object TX_EDEFAULT = Part2Factory.eINSTANCE.createFromString(Part2Package.eINSTANCE.getPositionType(), "0");
	 ...
	 * @ordered
	 */
	protected static final Object TY_EDEFAULT = Part2Factory.eINSTANCE.createFromString(Part2Package.eINSTANCE.getPositionType(), "0");
	...
	public EList<TreeTypes> getChildElements() {
		if (childElements == null) {
			childElements = new EObjectContainmentEList<TreeTypes>(TreeTypes.class, this, Part2Package.GROUP_PRIMITIVE__CHILD_ELEMENTS);
		}
	...
	public EList<TransformGroupPrimitive> getTransformGroup() {
		if (transformGroup == null) {
			transformGroup = new EObjectResolvingEList.Unsettable<TransformGroupPrimitive>(TransformGroupPrimitive.class, this, Part2Package.GROUP_PRIMITIVE__TRANSFORM_GROUP);
		}
	...
	public EList<ReplicatePrimitive> getReplicate() {
		if (replicate == null) {
			replicate = new EObjectResolvingEList.Unsettable<ReplicatePrimitive>(ReplicatePrimitive.class, this, Part2Package.GROUP_PRIMITIVE__REPLICATE);
		}
		return replicate;
	}
	...
	public EList<SwitchNodePrimitive> getSwitchNode() {
		if (switchNode == null) {
			switchNode = new EObjectResolvingEList.Unsettable<SwitchNodePrimitive>(SwitchNodePrimitive.class, this, Part2Package.GROUP_PRIMITIVE__SWITCH_NODE);
		}
		return switchNode;
	}
	...
	public EList<ClippingContainerPrimitive> getClippingContainer() {
		if (clippingContainer == null) {
			clippingContainer = new EObjectResolvingEList.Unsettable<ClippingContainerPrimitive>(ClippingContainerPrimitive.class, this, Part2Package.GROUP_PRIMITIVE__CLIPPING_CONTAINER);
		}
	...
	public EList<SimpleTextPrimitive> getSimpleText() {
		if (simpleText == null) {
			simpleText = new EObjectResolvingEList.Unsettable<SimpleTextPrimitive>(SimpleTextPrimitive.class, this, Part2Package.GROUP_PRIMITIVE__SIMPLE_TEXT);
		}
		return simpleText;
	}
	...
	public EList<PointerGestureAreaPrimitive> getPointerGestureArea() {
		if (pointerGestureArea == null) {
			pointerGestureArea = new EObjectResolvingEList.Unsettable<PointerGestureAreaPrimitive>(PointerGestureAreaPrimitive.class, this, Part2Package.GROUP_PRIMITIVE__POINTER_GESTURE_AREA);
		}
	...
	public EList<TouchAreaPrimitive> getTouchArea() {
		if (touchArea == null) {
			touchArea = new EObjectResolvingEList.Unsettable<TouchAreaPrimitive>(TouchAreaPrimitive.class, this, Part2Package.GROUP_PRIMITIVE__TOUCH_AREA);
		}
		return touchArea;
	}
	...
	public EList<ScrollWheelInputPrimitive> getScrollWheelInput() {
		if (scrollWheelInput == null) {
			scrollWheelInput = new EObjectResolvingEList.Unsettable<ScrollWheelInputPrimitive>(ScrollWheelInputPrimitive.class, this, Part2Package.GROUP_PRIMITIVE__SCROLL_WHEEL_INPUT);
		}
	...
	public void setBlocked(Object newBlocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__BLOCKED, oldBlocked, blocked, !oldBlockedESet));
	}
	...
	public void unsetBlocked() {
		...
		blockedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__BLOCKED, oldBlocked, BLOCKED_EDEFAULT, oldBlockedESet));
	}
	...
	public void setEnable(Object newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setInheritedBlocked(Object newInheritedBlocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, inheritedBlocked, !oldInheritedBlockedESet));
	}
	...
	public void unsetInheritedBlocked() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, INHERITED_BLOCKED_EDEFAULT, oldInheritedBlockedESet));
	}
	...
	public void setInheritedEnable(Object newInheritedEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, inheritedEnable, !oldInheritedEnableESet));
	}
	...
	public void unsetInheritedEnable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, INHERITED_ENABLE_EDEFAULT, oldInheritedEnableESet));
	}
	...
	public void setInheritedVisible(Object newInheritedVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, inheritedVisible, !oldInheritedVisibleESet));
	}
	...
	public void unsetInheritedVisible() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, INHERITED_VISIBLE_EDEFAULT, oldInheritedVisibleESet));
	}
	...
	public void setTx(Object newTx) {
		...
		txESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__TX, oldTx, tx, !oldTxESet));
	}
	...
	public void unsetTx() {
		...
		txESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__TX, oldTx, TX_EDEFAULT, oldTxESet));
	}
	...
	public void setTy(Object newTy) {
		...
		tyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__TY, oldTy, ty, !oldTyESet));
	}
	...
	public void unsetTy() {
		...
		tyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__TY, oldTy, TY_EDEFAULT, oldTyESet));
	}
	...
	public void setVisible(Object newVisible) {
		...
		visibleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.GROUP_PRIMITIVE__VISIBLE, oldVisible, visible, !oldVisibleESet));
	}
	...
	public void unsetVisible() {
		...
		visibleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.GROUP_PRIMITIVE__VISIBLE, oldVisible, VISIBLE_EDEFAULT, oldVisibleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Part2Package.GROUP_PRIMITIVE__GROUP:
				return getGroup();
			case Part2Package.GROUP_PRIMITIVE__TRANSFORM_GROUP:
				return getTransformGroup();
			case Part2Package.GROUP_PRIMITIVE__REPLICATE:
				return getReplicate();
			case Part2Package.GROUP_PRIMITIVE__CHILDREN:
				return getChildren();
			case Part2Package.GROUP_PRIMITIVE__SWITCH_NODE:
				return getSwitchNode();
			case Part2Package.GROUP_PRIMITIVE__CLIPPING_CONTAINER:
			...
			case Part2Package.GROUP_PRIMITIVE__IMAGE:
				return getImage();
			case Part2Package.GROUP_PRIMITIVE__SIMPLE_TEXT:
			...
			case Part2Package.GROUP_PRIMITIVE__POINTER_GESTURE_AREA:
			...
			case Part2Package.GROUP_PRIMITIVE__SCROLL_WHEEL_INPUT:
