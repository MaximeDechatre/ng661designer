...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relative Cubic Bezier Curve Command</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeCubicBezierCurveCommandImpl#getX <em>X</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeCubicBezierCurveCommandImpl#getX1 <em>X1</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeCubicBezierCurveCommandImpl#getX2 <em>X2</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeCubicBezierCurveCommandImpl#getY <em>Y</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeCubicBezierCurveCommandImpl#getY1 <em>Y1</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeCubicBezierCurveCommandImpl#getY2 <em>Y2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelativeCubicBezierCurveCommandImpl extends MinimalEObjectImpl.Container implements RelativeCubicBezierCurveCommand {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected RelativeCubicBezierCurveCommandImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getRelativeCubicBezierCurveCommand();
	}
	...
	public void setX(Object newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_CUBIC_BEZIER_CURVE_COMMAND__X, oldX, x));
	}
	...
	public void setX1(Object newX1) {
		...
		x1 = newX1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_CUBIC_BEZIER_CURVE_COMMAND__X1, oldX1, x1));
	}
	...
	public void setX2(Object newX2) {
		...
		x2 = newX2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_CUBIC_BEZIER_CURVE_COMMAND__X2, oldX2, x2));
	}
	...
	public void setY(Object newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_CUBIC_BEZIER_CURVE_COMMAND__Y, oldY, y));
	}
	...
	public void setY1(Object newY1) {
		...
		y1 = newY1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_CUBIC_BEZIER_CURVE_COMMAND__Y1, oldY1, y1));
	}
	...
	public void setY2(Object newY2) {
		...
		y2 = newY2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_CUBIC_BEZIER_CURVE_COMMAND__Y2, oldY2, y2));
	}
...
} //RelativeCubicBezierCurveCommandImpl
