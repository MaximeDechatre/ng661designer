...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pointer Gesture Area Primitive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getAcceptedButtons <em>Accepted Buttons</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getAcceptedGesture <em>Accepted Gesture</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getBlocked <em>Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getCursor <em>Cursor</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getEnable <em>Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getInheritedBlocked <em>Inherited Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getInheritedEnable <em>Inherited Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getInheritedVisible <em>Inherited Visible</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getTrackOutside <em>Track Outside</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getVisible <em>Visible</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getX <em>X</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointerGestureAreaPrimitiveImpl#getY <em>Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointerGestureAreaPrimitiveImpl extends TreeTypesImpl implements PointerGestureAreaPrimitive {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected PointerGestureAreaPrimitiveImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getPointerGestureAreaPrimitive();
	}
	...
	public void setAcceptedButtons(String newAcceptedButtons) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ACCEPTED_BUTTONS, oldAcceptedButtons, acceptedButtons, !oldAcceptedButtonsESet));
	}
	...
	public void unsetAcceptedButtons() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ACCEPTED_BUTTONS, oldAcceptedButtons, ACCEPTED_BUTTONS_EDEFAULT, oldAcceptedButtonsESet));
	}
	...
	public void setAcceptedGesture(String newAcceptedGesture) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ACCEPTED_GESTURE, oldAcceptedGesture, acceptedGesture, !oldAcceptedGestureESet));
	}
	...
	public void unsetAcceptedGesture() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ACCEPTED_GESTURE, oldAcceptedGesture, ACCEPTED_GESTURE_EDEFAULT, oldAcceptedGestureESet));
	}
	...
	public void setBlocked(Object newBlocked) {
		...
		blockedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__BLOCKED, oldBlocked, blocked, !oldBlockedESet));
	}
	...
	public void unsetBlocked() {
		...
		blockedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__BLOCKED, oldBlocked, BLOCKED_EDEFAULT, oldBlockedESet));
	}
	...
	public void setCursor(String newCursor) {
		...
		cursor = newCursor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__CURSOR, oldCursor, cursor));
	}
	...
	public void setEnable(Object newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setHeight(Object newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__HEIGHT, oldHeight, height));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__ID, oldId, id));
	}
	...
	public void setInheritedBlocked(Object newInheritedBlocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, inheritedBlocked, !oldInheritedBlockedESet));
	}
	...
	public void unsetInheritedBlocked() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, INHERITED_BLOCKED_EDEFAULT, oldInheritedBlockedESet));
	}
	...
	public void setInheritedEnable(Object newInheritedEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, inheritedEnable, !oldInheritedEnableESet));
	}
	...
	public void unsetInheritedEnable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, INHERITED_ENABLE_EDEFAULT, oldInheritedEnableESet));
	}
	...
	public void setInheritedVisible(Object newInheritedVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, inheritedVisible, !oldInheritedVisibleESet));
	}
	...
	public void unsetInheritedVisible() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, INHERITED_VISIBLE_EDEFAULT, oldInheritedVisibleESet));
	}
	...
	public void setTrackOutside(Object newTrackOutside) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__TRACK_OUTSIDE, oldTrackOutside, trackOutside, !oldTrackOutsideESet));
	}
	...
	public void unsetTrackOutside() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__TRACK_OUTSIDE, oldTrackOutside, TRACK_OUTSIDE_EDEFAULT, oldTrackOutsideESet));
	}
	...
	public void setVisible(Object newVisible) {
		...
		visibleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__VISIBLE, oldVisible, visible, !oldVisibleESet));
	}
	...
	public void unsetVisible() {
		...
		visibleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__VISIBLE, oldVisible, VISIBLE_EDEFAULT, oldVisibleESet));
	}
	...
	public void setWidth(Object newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__WIDTH, oldWidth, width));
	}
	...
	public void setX(Object newX) {
		...
		xESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__X, oldX, x, !oldXESet));
	}
	...
	public void unsetX() {
		...
		xESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__X, oldX, X_EDEFAULT, oldXESet));
	}
	...
	public void setY(Object newY) {
		...
		yESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__Y, oldY, y, !oldYESet));
	}
	...
	public void unsetY() {
		...
		yESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.POINTER_GESTURE_AREA_PRIMITIVE__Y, oldY, Y_EDEFAULT, oldYESet));
	}
...
} //PointerGestureAreaPrimitiveImpl
