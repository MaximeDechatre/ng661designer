 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PointTypeImpl#getY <em>Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PointTypeImpl extends MinimalEObjectImpl.Container implements PointType {
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getPointType();
	}
	...
	public void setX(Object newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINT_TYPE__X, oldX, x));
	}
	...
	public void setY(Object newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.POINT_TYPE__Y, oldY, y));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Part2Package.POINT_TYPE__X:
				return getX();
			case Part2Package.POINT_TYPE__Y:
				return getY();
		}
