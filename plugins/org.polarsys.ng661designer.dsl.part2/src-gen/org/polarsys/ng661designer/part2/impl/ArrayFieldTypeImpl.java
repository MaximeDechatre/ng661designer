 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getOtherEntries <em>Other Entries</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getArrayEntry <em>Array Entry</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getOtherArrayEntries <em>Other Array Entries</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getStructEntry <em>Struct Entry</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getOtherStructEntries <em>Other Struct Entries</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getUnionEntry <em>Union Entry</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getOtherUnionEntries <em>Other Union Entries</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getMaxNumberOfEntries <em>Max Number Of Entries</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.ArrayFieldTypeImpl#getNumberOfEntries <em>Number Of Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayFieldTypeImpl extends MinimalEObjectImpl.Container implements ArrayFieldType {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getArrayFieldType();
	}
	...
	public EList<EntryType> getEntry() {
		if (entry == null) {
			entry = new EObjectContainmentEList<EntryType>(EntryType.class, this, Part2Package.ARRAY_FIELD_TYPE__ENTRY);
		}
		return entry;
	}
	...
	public NotificationChain basicSetOtherEntries(OtherEntriesType newOtherEntries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_ENTRIES, oldOtherEntries, newOtherEntries);
	...
	public void setOtherEntries(OtherEntriesType newOtherEntries) {
		if (newOtherEntries != otherEntries) {
			...
			if (otherEntries != null)
				msgs = ((InternalEObject)otherEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_ENTRIES, null, msgs);
			if (newOtherEntries != null)
				msgs = ((InternalEObject)newOtherEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_ENTRIES, null, msgs);
			msgs = basicSetOtherEntries(newOtherEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_ENTRIES, newOtherEntries, newOtherEntries));
	}
	...
	public EList<ArrayEntryType> getArrayEntry() {
		if (arrayEntry == null) {
			arrayEntry = new EObjectContainmentEList<ArrayEntryType>(ArrayEntryType.class, this, Part2Package.ARRAY_FIELD_TYPE__ARRAY_ENTRY);
		}
		return arrayEntry;
	}
	...
	public NotificationChain basicSetOtherArrayEntries(OtherArrayEntriesType newOtherArrayEntries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_ARRAY_ENTRIES, oldOtherArrayEntries, newOtherArrayEntries);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOtherArrayEntries(OtherArrayEntriesType newOtherArrayEntries) {
		if (newOtherArrayEntries != otherArrayEntries) {
			...
			if (otherArrayEntries != null)
				msgs = ((InternalEObject)otherArrayEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_ARRAY_ENTRIES, null, msgs);
			if (newOtherArrayEntries != null)
				msgs = ((InternalEObject)newOtherArrayEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_ARRAY_ENTRIES, null, msgs);
			msgs = basicSetOtherArrayEntries(newOtherArrayEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_ARRAY_ENTRIES, newOtherArrayEntries, newOtherArrayEntries));
	}
	...
	public EList<StructEntryType> getStructEntry() {
		if (structEntry == null) {
			structEntry = new EObjectContainmentEList<StructEntryType>(StructEntryType.class, this, Part2Package.ARRAY_FIELD_TYPE__STRUCT_ENTRY);
		}
		return structEntry;
	}
	...
	public NotificationChain basicSetOtherStructEntries(OtherStructEntriesType newOtherStructEntries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_STRUCT_ENTRIES, oldOtherStructEntries, newOtherStructEntries);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOtherStructEntries(OtherStructEntriesType newOtherStructEntries) {
		if (newOtherStructEntries != otherStructEntries) {
			...
			if (otherStructEntries != null)
				msgs = ((InternalEObject)otherStructEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_STRUCT_ENTRIES, null, msgs);
			if (newOtherStructEntries != null)
				msgs = ((InternalEObject)newOtherStructEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_STRUCT_ENTRIES, null, msgs);
			msgs = basicSetOtherStructEntries(newOtherStructEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_STRUCT_ENTRIES, newOtherStructEntries, newOtherStructEntries));
	}
	...
	public EList<UnionEntryType> getUnionEntry() {
		if (unionEntry == null) {
			unionEntry = new EObjectContainmentEList<UnionEntryType>(UnionEntryType.class, this, Part2Package.ARRAY_FIELD_TYPE__UNION_ENTRY);
		}
		return unionEntry;
	}
	...
	public NotificationChain basicSetOtherUnionEntries(OtherUnionEntriesType newOtherUnionEntries, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_UNION_ENTRIES, oldOtherUnionEntries, newOtherUnionEntries);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOtherUnionEntries(OtherUnionEntriesType newOtherUnionEntries) {
		if (newOtherUnionEntries != otherUnionEntries) {
			...
			if (otherUnionEntries != null)
				msgs = ((InternalEObject)otherUnionEntries).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_UNION_ENTRIES, null, msgs);
			if (newOtherUnionEntries != null)
				msgs = ((InternalEObject)newOtherUnionEntries).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Part2Package.ARRAY_FIELD_TYPE__OTHER_UNION_ENTRIES, null, msgs);
			msgs = basicSetOtherUnionEntries(newOtherUnionEntries, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__OTHER_UNION_ENTRIES, newOtherUnionEntries, newOtherUnionEntries));
	}
	...
	public void setMaxNumberOfEntries(BigInteger newMaxNumberOfEntries) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__MAX_NUMBER_OF_ENTRIES, oldMaxNumberOfEntries, maxNumberOfEntries));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__NAME, oldName, name));
	}
	...
	public void setNumberOfEntries(BigInteger newNumberOfEntries) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.ARRAY_FIELD_TYPE__NUMBER_OF_ENTRIES, oldNumberOfEntries, numberOfEntries));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Part2Package.ARRAY_FIELD_TYPE__ENTRY:
				return ((InternalEList<?>)getEntry()).basicRemove(otherEnd, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__OTHER_ENTRIES:
				return basicSetOtherEntries(null, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__ARRAY_ENTRY:
				return ((InternalEList<?>)getArrayEntry()).basicRemove(otherEnd, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__OTHER_ARRAY_ENTRIES:
				return basicSetOtherArrayEntries(null, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__STRUCT_ENTRY:
				return ((InternalEList<?>)getStructEntry()).basicRemove(otherEnd, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__OTHER_STRUCT_ENTRIES:
				return basicSetOtherStructEntries(null, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__UNION_ENTRY:
				return ((InternalEList<?>)getUnionEntry()).basicRemove(otherEnd, msgs);
			case Part2Package.ARRAY_FIELD_TYPE__OTHER_UNION_ENTRIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Part2Package.ARRAY_FIELD_TYPE__MAX_NUMBER_OF_ENTRIES:
				return getMaxNumberOfEntries();
			case Part2Package.ARRAY_FIELD_TYPE__NAME:
				return getName();
			case Part2Package.ARRAY_FIELD_TYPE__NUMBER_OF_ENTRIES:
