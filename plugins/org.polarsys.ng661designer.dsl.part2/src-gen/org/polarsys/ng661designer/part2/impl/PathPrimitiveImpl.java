 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getD <em>D</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getBlocked <em>Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getDrawingPriority <em>Drawing Priority</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getEnable <em>Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getFillOpacity <em>Fill Opacity</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getFillRule <em>Fill Rule</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getInheritedBlocked <em>Inherited Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getInheritedEnable <em>Inherited Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getInheritedVisible <em>Inherited Visible</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStroke <em>Stroke</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokeDasharray <em>Stroke Dasharray</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokeDashoffset <em>Stroke Dashoffset</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokeLinecap <em>Stroke Linecap</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokeLinejoin <em>Stroke Linejoin</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokeMiterlimit <em>Stroke Miterlimit</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokeOpacity <em>Stroke Opacity</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getStrokewidth <em>Strokewidth</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.PathPrimitiveImpl#getVisible <em>Visible</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PathPrimitiveImpl extends ClipPathTypesImpl implements PathPrimitive {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public NotificationChain basicSetD(PathArray newD, NotificationChain msgs) {
		PathArray oldD = d;
		d = newD;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__D, oldD, newD);
	 ...
	 * @generated
	 */
	public void setD(PathArray newD) {
		if (newD != d) {
			NotificationChain msgs = null;
			if (d != null)
				msgs = ((InternalEObject)d).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Part2Package.PATH_PRIMITIVE__D, null, msgs);
			if (newD != null)
				msgs = ((InternalEObject)newD).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Part2Package.PATH_PRIMITIVE__D, null, msgs);
			msgs = basicSetD(newD, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__D, newD, newD));
	}
	...
	public void setBlocked(Object newBlocked) {
		...
		blockedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__BLOCKED, oldBlocked, blocked, !oldBlockedESet));
	}
	...
	public void unsetBlocked() {
		...
		blockedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.PATH_PRIMITIVE__BLOCKED, oldBlocked, BLOCKED_EDEFAULT, oldBlockedESet));
	}
	...
	public void setEnable(Object newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.PATH_PRIMITIVE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setInheritedBlocked(Object newInheritedBlocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, inheritedBlocked, !oldInheritedBlockedESet));
	}
	...
	public void unsetInheritedBlocked() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.PATH_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, INHERITED_BLOCKED_EDEFAULT, oldInheritedBlockedESet));
	}
	...
	public void setInheritedEnable(Object newInheritedEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, inheritedEnable, !oldInheritedEnableESet));
	}
	...
	public void unsetInheritedEnable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.PATH_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, INHERITED_ENABLE_EDEFAULT, oldInheritedEnableESet));
	}
	...
	public void setInheritedVisible(Object newInheritedVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, inheritedVisible, !oldInheritedVisibleESet));
	}
	...
	public void unsetInheritedVisible() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.PATH_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, INHERITED_VISIBLE_EDEFAULT, oldInheritedVisibleESet));
	}
	...
	public void setVisible(Object newVisible) {
		...
		visibleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.PATH_PRIMITIVE__VISIBLE, oldVisible, visible, !oldVisibleESet));
	}
	...
	public void unsetVisible() {
		...
		visibleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.PATH_PRIMITIVE__VISIBLE, oldVisible, VISIBLE_EDEFAULT, oldVisibleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Part2Package.PATH_PRIMITIVE__D:
				return getD();
			case Part2Package.PATH_PRIMITIVE__BLOCKED:
				return getBlocked();
			case Part2Package.PATH_PRIMITIVE__DRAWING_PRIORITY:
				return getDrawingPriority();
			case Part2Package.PATH_PRIMITIVE__ENABLE:
				return getEnable();
			...
			case Part2Package.PATH_PRIMITIVE__ID:
				return getId();
			case Part2Package.PATH_PRIMITIVE__INHERITED_BLOCKED:
				return getInheritedBlocked();
			case Part2Package.PATH_PRIMITIVE__INHERITED_ENABLE:
				return getInheritedEnable();
			case Part2Package.PATH_PRIMITIVE__INHERITED_VISIBLE:
			...
			case Part2Package.PATH_PRIMITIVE__VISIBLE:
				return getVisible();
		}
