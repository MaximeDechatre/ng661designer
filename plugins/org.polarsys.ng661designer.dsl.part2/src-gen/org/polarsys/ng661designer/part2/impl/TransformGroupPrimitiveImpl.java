...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Transform Group Primitive</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getChildElements <em>Child Elements</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getTransformGroup <em>Transform Group</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getReplicate <em>Replicate</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getSwitchNode <em>Switch Node</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getClippingContainer <em>Clipping Container</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getRectangle <em>Rectangle</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getCircle <em>Circle</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getEllipse <em>Ellipse</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getLine <em>Line</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getPolyline <em>Polyline</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getPolygon <em>Polygon</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getImage <em>Image</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getSimpleText <em>Simple Text</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getArc <em>Arc</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getCrown <em>Crown</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getPolarLine <em>Polar Line</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getPointerArea <em>Pointer Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getPointerGestureArea <em>Pointer Gesture Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getTouchArea <em>Touch Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getGestureArea <em>Gesture Area</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getKeyboardInput <em>Keyboard Input</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getScrollWheelInput <em>Scroll Wheel Input</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getCompositions <em>Compositions</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getBlocked <em>Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getDrawingPriority <em>Drawing Priority</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getEnable <em>Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getInheritedBlocked <em>Inherited Blocked</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getInheritedEnable <em>Inherited Enable</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getInheritedVisible <em>Inherited Visible</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.TransformGroupPrimitiveImpl#getVisible <em>Visible</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransformGroupPrimitiveImpl extends TreeTypesImpl implements TransformGroupPrimitive {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected TransformGroupPrimitiveImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getTransformGroupPrimitive();
	}
	...
	public EList<TreeTypes> getChildElements() {
		if (childElements == null) {
			childElements = new EObjectContainmentEList<TreeTypes>(TreeTypes.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__CHILD_ELEMENTS);
		}
	...
	public NotificationChain basicSetTransform(TransformType newTransform, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM, oldTransform, newTransform);
	...
	public void setTransform(TransformType newTransform) {
		if (newTransform != transform) {
			...
			if (transform != null)
				msgs = ((InternalEObject)transform).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM, null, msgs);
			if (newTransform != null)
				msgs = ((InternalEObject)newTransform).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM, null, msgs);
			msgs = basicSetTransform(newTransform, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM, newTransform, newTransform));
	}
	...
	public EList<GroupPrimitive> getGroup() {
		if (group == null) {
			group = new EObjectResolvingEList.Unsettable<GroupPrimitive>(GroupPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__GROUP);
		}
		return group;
	}
	...
	public EList<TransformGroupPrimitive> getTransformGroup() {
		if (transformGroup == null) {
			transformGroup = new EObjectResolvingEList.Unsettable<TransformGroupPrimitive>(TransformGroupPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM_GROUP);
		}
	...
	public EList<ReplicatePrimitive> getReplicate() {
		if (replicate == null) {
			replicate = new EObjectResolvingEList.Unsettable<ReplicatePrimitive>(ReplicatePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__REPLICATE);
		}
		return replicate;
	}
	...
	public EList<ChildPrimitive> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList.Unsettable<ChildPrimitive>(ChildPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__CHILDREN);
		}
		return children;
	}
	...
	public EList<SwitchNodePrimitive> getSwitchNode() {
		if (switchNode == null) {
			switchNode = new EObjectResolvingEList.Unsettable<SwitchNodePrimitive>(SwitchNodePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__SWITCH_NODE);
		}
		return switchNode;
	}
	...
	public EList<ClippingContainerPrimitive> getClippingContainer() {
		if (clippingContainer == null) {
			clippingContainer = new EObjectResolvingEList.Unsettable<ClippingContainerPrimitive>(ClippingContainerPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__CLIPPING_CONTAINER);
		}
	...
	public EList<RectPrimitive> getRectangle() {
		if (rectangle == null) {
			rectangle = new EObjectResolvingEList.Unsettable<RectPrimitive>(RectPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__RECTANGLE);
		}
		return rectangle;
	}
	...
	public EList<CirclePrimitive> getCircle() {
		if (circle == null) {
			circle = new EObjectResolvingEList.Unsettable<CirclePrimitive>(CirclePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__CIRCLE);
		}
		return circle;
	}
	...
	public EList<EllipsePrimitive> getEllipse() {
		if (ellipse == null) {
			ellipse = new EObjectResolvingEList.Unsettable<EllipsePrimitive>(EllipsePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__ELLIPSE);
		}
		return ellipse;
	}
	...
	public EList<LinePrimitive> getLine() {
		if (line == null) {
			line = new EObjectResolvingEList.Unsettable<LinePrimitive>(LinePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__LINE);
		}
		return line;
	}
	...
	public EList<PolylinePrimitive> getPolyline() {
		if (polyline == null) {
			polyline = new EObjectResolvingEList.Unsettable<PolylinePrimitive>(PolylinePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__POLYLINE);
		}
		return polyline;
	}
	...
	public EList<PolygonPrimitive> getPolygon() {
		if (polygon == null) {
			polygon = new EObjectResolvingEList.Unsettable<PolygonPrimitive>(PolygonPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__POLYGON);
		}
		return polygon;
	}
	...
	public EList<PathPrimitive> getPath() {
		if (path == null) {
			path = new EObjectResolvingEList.Unsettable<PathPrimitive>(PathPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__PATH);
		}
		return path;
	}
	...
	public EList<ImagePrimitive> getImage() {
		if (image == null) {
			image = new EObjectResolvingEList.Unsettable<ImagePrimitive>(ImagePrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__IMAGE);
		}
		return image;
	}
	...
	public EList<SimpleTextPrimitive> getSimpleText() {
		if (simpleText == null) {
			simpleText = new EObjectResolvingEList.Unsettable<SimpleTextPrimitive>(SimpleTextPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__SIMPLE_TEXT);
		}
		return simpleText;
	}
	...
	public EList<ArcComponent> getArc() {
		if (arc == null) {
			arc = new EObjectResolvingEList.Unsettable<ArcComponent>(ArcComponent.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__ARC);
		}
		return arc;
	}
	...
	public EList<CrownComponent> getCrown() {
		if (crown == null) {
			crown = new EObjectResolvingEList.Unsettable<CrownComponent>(CrownComponent.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__CROWN);
		}
		return crown;
	}
	...
	public EList<PolarLineComponent> getPolarLine() {
		if (polarLine == null) {
			polarLine = new EObjectResolvingEList.Unsettable<PolarLineComponent>(PolarLineComponent.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__POLAR_LINE);
		}
		return polarLine;
	}
	...
	public EList<PointerAreaPrimitive> getPointerArea() {
		if (pointerArea == null) {
			pointerArea = new EObjectResolvingEList.Unsettable<PointerAreaPrimitive>(PointerAreaPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__POINTER_AREA);
		}
		return pointerArea;
	}
	...
	public EList<PointerGestureAreaPrimitive> getPointerGestureArea() {
		if (pointerGestureArea == null) {
			pointerGestureArea = new EObjectResolvingEList.Unsettable<PointerGestureAreaPrimitive>(PointerGestureAreaPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__POINTER_GESTURE_AREA);
		}
	...
	public EList<TouchAreaPrimitive> getTouchArea() {
		if (touchArea == null) {
			touchArea = new EObjectResolvingEList.Unsettable<TouchAreaPrimitive>(TouchAreaPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__TOUCH_AREA);
		}
		return touchArea;
	}
	...
	public EList<GestureAreaPrimitive> getGestureArea() {
		if (gestureArea == null) {
			gestureArea = new EObjectResolvingEList.Unsettable<GestureAreaPrimitive>(GestureAreaPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__GESTURE_AREA);
		}
		return gestureArea;
	}
	...
	public EList<KeyboardInputPrimitive> getKeyboardInput() {
		if (keyboardInput == null) {
			keyboardInput = new EObjectResolvingEList.Unsettable<KeyboardInputPrimitive>(KeyboardInputPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__KEYBOARD_INPUT);
		}
	...
	public EList<ScrollWheelInputPrimitive> getScrollWheelInput() {
		if (scrollWheelInput == null) {
			scrollWheelInput = new EObjectResolvingEList.Unsettable<ScrollWheelInputPrimitive>(ScrollWheelInputPrimitive.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__SCROLL_WHEEL_INPUT);
		}
	...
	public EList<WidgetComposition> getCompositions() {
		if (compositions == null) {
			compositions = new EObjectResolvingEList.Unsettable<WidgetComposition>(WidgetComposition.class, this, Part2Package.TRANSFORM_GROUP_PRIMITIVE__COMPOSITIONS);
		}
		return compositions;
	}
	...
	public void setBlocked(Object newBlocked) {
		...
		blockedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__BLOCKED, oldBlocked, blocked, !oldBlockedESet));
	}
	...
	public void unsetBlocked() {
		...
		blockedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__BLOCKED, oldBlocked, BLOCKED_EDEFAULT, oldBlockedESet));
	}
	...
	public void setDrawingPriority(Object newDrawingPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__DRAWING_PRIORITY, oldDrawingPriority, drawingPriority, !oldDrawingPriorityESet));
	}
	...
	public void unsetDrawingPriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__DRAWING_PRIORITY, oldDrawingPriority, DRAWING_PRIORITY_EDEFAULT, oldDrawingPriorityESet));
	}
	...
	public void setEnable(Object newEnable) {
		...
		enableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__ENABLE, oldEnable, enable, !oldEnableESet));
	}
	...
	public void unsetEnable() {
		...
		enableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__ENABLE, oldEnable, ENABLE_EDEFAULT, oldEnableESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__ID, oldId, id));
	}
	...
	public void setInheritedBlocked(Object newInheritedBlocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, inheritedBlocked, !oldInheritedBlockedESet));
	}
	...
	public void unsetInheritedBlocked() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__INHERITED_BLOCKED, oldInheritedBlocked, INHERITED_BLOCKED_EDEFAULT, oldInheritedBlockedESet));
	}
	...
	public void setInheritedEnable(Object newInheritedEnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, inheritedEnable, !oldInheritedEnableESet));
	}
	...
	public void unsetInheritedEnable() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__INHERITED_ENABLE, oldInheritedEnable, INHERITED_ENABLE_EDEFAULT, oldInheritedEnableESet));
	}
	...
	public void setInheritedVisible(Object newInheritedVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, inheritedVisible, !oldInheritedVisibleESet));
	}
	...
	public void unsetInheritedVisible() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__INHERITED_VISIBLE, oldInheritedVisible, INHERITED_VISIBLE_EDEFAULT, oldInheritedVisibleESet));
	}
	...
	public void setVisible(Object newVisible) {
		...
		visibleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__VISIBLE, oldVisible, visible, !oldVisibleESet));
	}
	...
	public void unsetVisible() {
		...
		visibleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Part2Package.TRANSFORM_GROUP_PRIMITIVE__VISIBLE, oldVisible, VISIBLE_EDEFAULT, oldVisibleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM:
				return getTransform();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__GROUP:
				return getGroup();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__TRANSFORM_GROUP:
				return getTransformGroup();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__REPLICATE:
				return getReplicate();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__CHILDREN:
				return getChildren();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__SWITCH_NODE:
				return getSwitchNode();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__CLIPPING_CONTAINER:
				return getClippingContainer();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__RECTANGLE:
				return getRectangle();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__CIRCLE:
				return getCircle();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__ELLIPSE:
				return getEllipse();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__LINE:
				return getLine();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__POLYLINE:
				return getPolyline();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__POLYGON:
				return getPolygon();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__PATH:
				return getPath();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__IMAGE:
				return getImage();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__SIMPLE_TEXT:
				return getSimpleText();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__ARC:
				return getArc();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__CROWN:
				return getCrown();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__POLAR_LINE:
				return getPolarLine();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__POINTER_AREA:
				return getPointerArea();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__POINTER_GESTURE_AREA:
				return getPointerGestureArea();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__TOUCH_AREA:
				return getTouchArea();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__GESTURE_AREA:
				return getGestureArea();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__KEYBOARD_INPUT:
				return getKeyboardInput();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__SCROLL_WHEEL_INPUT:
				return getScrollWheelInput();
			case Part2Package.TRANSFORM_GROUP_PRIMITIVE__COMPOSITIONS:
