...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Underline Properties</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.UnderlinePropertiesImpl#getActive <em>Active</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.UnderlinePropertiesImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.UnderlinePropertiesImpl#getStrokeWidth <em>Stroke Width</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnderlinePropertiesImpl extends MinimalEObjectImpl.Container implements UnderlineProperties {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected UnderlinePropertiesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getUnderlineProperties();
	}
	...
	public void setActive(Object newActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.UNDERLINE_PROPERTIES__ACTIVE, oldActive, active));
	}
	...
	public void setDistance(Object newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.UNDERLINE_PROPERTIES__DISTANCE, oldDistance, distance));
	}
	...
	public void setStrokeWidth(Object newStrokeWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.UNDERLINE_PROPERTIES__STROKE_WIDTH, oldStrokeWidth, strokeWidth));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Part2Package.UNDERLINE_PROPERTIES__ACTIVE:
				return getActive();
			case Part2Package.UNDERLINE_PROPERTIES__DISTANCE:
				return getDistance();
			case Part2Package.UNDERLINE_PROPERTIES__STROKE_WIDTH:
