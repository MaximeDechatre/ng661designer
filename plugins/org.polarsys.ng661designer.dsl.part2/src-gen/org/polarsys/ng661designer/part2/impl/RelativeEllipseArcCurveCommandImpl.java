...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relative Ellipse Arc Curve Command</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getAngle <em>Angle</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getLargeArcFlag <em>Large Arc Flag</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getR1 <em>R1</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getR2 <em>R2</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getSweepFlag <em>Sweep Flag</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getX <em>X</em>}</li>
 *   <li>{@link org.polarsys.ng661designer.part2.impl.RelativeEllipseArcCurveCommandImpl#getY <em>Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelativeEllipseArcCurveCommandImpl extends MinimalEObjectImpl.Container implements RelativeEllipseArcCurveCommand {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected RelativeEllipseArcCurveCommandImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Part2Package.eINSTANCE.getRelativeEllipseArcCurveCommand();
	}
	...
	public void setAngle(Object newAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__ANGLE, oldAngle, angle));
	}
	...
	public void setLargeArcFlag(Object newLargeArcFlag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__LARGE_ARC_FLAG, oldLargeArcFlag, largeArcFlag));
	}
	...
	public void setR1(Object newR1) {
		...
		r1 = newR1;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__R1, oldR1, r1));
	}
	...
	public void setR2(Object newR2) {
		...
		r2 = newR2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__R2, oldR2, r2));
	}
	...
	public void setSweepFlag(Object newSweepFlag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__SWEEP_FLAG, oldSweepFlag, sweepFlag));
	}
	...
	public void setX(Object newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__X, oldX, x));
	}
	...
	public void setY(Object newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Part2Package.RELATIVE_ELLIPSE_ARC_CURVE_COMMAND__Y, oldY, y));
	}
...
} //RelativeEllipseArcCurveCommandImpl
